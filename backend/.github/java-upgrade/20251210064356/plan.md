...
- **Working branch**: appmod/java-upgrade-20251210064356
...
- **Source JDK path (Java 17)**: C:\Users\yc385\.jdk\jdk-17.0.16\bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251210064356`.
